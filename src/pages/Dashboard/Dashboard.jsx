...
export default function Dashboard() {
  ...
  useEffect(() => {
    const firstMatch = popularItems.find((product) =>
      product.name.toLowerCase().includes(searchTerm.toLowerCase()),
    );
          ...
          <Grid container spacing={1} sx={{ mt: 2 }}>
            <Grid item xs={8} md={4} spacing={2}>
              ...
              <TextField
                ...
                sx={{ mb: 2 }}
              />
              <PopularList title="Itens populares" items={filteredProducts} />
            </Grid>
            <Grid item xs={8}>
              <ChartColumn title="Vendas nos últimos meses" data={salesData} />
            </Grid>
          </Grid>
        </Grid>
      </Box>
